...
public interface SysUserMapper {
    ...
    List<Pair<String, Long>> selectGroupUserCount();


    List<SysUser> selectUserInSet(String userIds);
    ...
    List<UserStatisticsMajorEntity> statisticsMajor();

    List<UserStatisticsYearNumberEntity> statisticsYearNumber();
}
