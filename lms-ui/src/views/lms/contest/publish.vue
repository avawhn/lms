<template>
    <div class="app-container">
        ...
        >
            ...
            <el-form-item label="测试时长" prop="contestTime">
                <el-input-number v-model="form.contestTime" :min="10"  /> <span style="margin-left: 10px;">分钟</span>
            </el-form-item>
            ...
            <div style="text-align: center">
                <el-button type="primary" plain @click="submitAddContest"
                    >发布测试</el-button
                >
            </div>
        </el-form>
